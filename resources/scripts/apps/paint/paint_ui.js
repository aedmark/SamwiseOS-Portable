window.PaintUI = class PaintUI {
    ...
    _buildAndShow(initialState) {
        ...
        const toolGroup = Utils.createElement("div", { className: "paint-tool-group" }, [
            (this.elements.pencilBtn = createToolBtn("pencil", "p", "✏")), (this.elements.eraserBtn = createToolBtn("eraser", "e", "✐")),
            (this.elements.lineBtn = createToolBtn("line", "l", "▬")), (this.elements.rectBtn = createToolBtn("rect", "r", "▢")),
            (this.elements.circleBtn = createToolBtn("circle", "c", "◎")), (this.elements.fillBtn = createToolBtn("fill", "f", "▩")),
    ...
    updateToolbar(state) {
        ...
        ["pencil", "eraser", "line", "rect", "circle", "fill", "select"].forEach(
            (tool) => { this.elements[`${tool}Btn`].classList.toggle("active", state.currentTool === tool); }
        );
    ...
    updateZoom(zoomLevel) {
        ...
        const gridShouldBeVisible = zoomLevel >= 70 && this.managerCallbacks.isGridVisible ? this.managerCallbacks.isGridVisible() : false;
    ...
    _addEventListeners() {
        ...
        this.elements.brushSizeInput.addEventListener("change", () => this.managerCallbacks.onBrushSizeChange(parseInt(this.elements.brushSizeInput.value, 10)));
        ...
        this.elements.canvas.addEventListener("mouseleave", () => this.updateStatusBar(this.managerCallbacks.onGetState(), null));
