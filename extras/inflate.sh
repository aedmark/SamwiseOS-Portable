...
# inflate.sh - The SamwiseOS Instant Universe Generator (v5.1)
...
echo "" >> ./README.md
echo "Congratulations, you've successfully inflated your environment! This little world was created just for you, a playground to test the awesome (and frankly, absurd) power of SamwiseOS." >> ./README.md
echo "" >> ./README.md
...
echo "# The Grand Library of SamwiseOS" > ./docs/index.md
echo "All the knowledge you seek is within this directory. Probably." >> ./docs/index.md

echo "### SamwiseOS Command Reference" > ./docs/api/command_reference.md
...
echo "### The SamwiseOS Permission Model" > ./docs/api/permissions.md
...
echo "Welcome to SamwiseOS v3.5! Today's forecast: 100% chance of awesome." > /etc/motd
echo "127.0.0.1 localhost samwise.local" > /etc/hosts
chmod 644 /etc/motd
chmod 644 /etc/hosts
...
echo "*********************************************************"
echo "Your SamwiseOS drive is now ready for exploration."
echo " "
...
echo "# My SamwiseOS Todo List" > ./todo.txt
